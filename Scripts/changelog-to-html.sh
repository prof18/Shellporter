...
if [[ -z "$version_content" ]]; then
  echo "<h2>Shellporter $VERSION</h2>"
  echo "<p>Latest Shellporter update.</p>"
  echo "<p><a href=\"https://github.com/prof18/shellporter/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
